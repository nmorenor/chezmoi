...
type SetJoinSessionNameScene struct {
}

func (scene *SetJoinSessionNameScene) Type() string { return "JoiSession" }

// Preload is called before loading any assets from the disk,
// to allow you to register / queue them
func (scene *SetJoinSessionNameScene) Preload() {
	files := []string{
		"textures/button.png",
		"fonts/pixelfont.ttf",
	}
...
func (scene *SetJoinSessionNameScene) Setup(updater engo.Updater) {
